 ...
 */
@Component
public class ReadExcel implements ReadExcelinterface {	
	
	@Value("${app.filepath}")
	private String fileDirectory;
	
	/* (non-Javadoc)
	 * @see com.crealytics.report.Reporting.controller.ReadExcelinterface#persistData()
	 */
	@Override
	public List<ExcelData> persistData() {
		
		ReadExcelinterface readExcel = new ReadExcel();		
	 ...
	 * @param file
	 */
	public List<ExcelData> parseCSVFile(String file) {
	 ...
	 * @return
	 */
	private double calculateEffectiveCostPerThousand(double revenue, Long impressions) {
	 ...
	 * @return
	 */
	private double calculateFillRate(Long impressions, Long requests) {
		// TODO Auto-generated method stub
	 ...
	 * @return
	 */
	private double calculateConversionRate(Long conversions, Long impressions) {
		// TODO Auto-generated method stub
	 ...
	 * @return
	 */
	private double roundNumber(long l) {
	 ...
	 * @return
	 */
	public List<String> parseForCsvFiles(String parentDirectory) {
